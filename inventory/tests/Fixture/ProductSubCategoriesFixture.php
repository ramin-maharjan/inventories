...
class ProductSubCategoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'descriptions' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2017-07-26 11:00:41',
            'modified' => '2017-07-26 11:00:41'
        ],
    ];
}
