...
class BookmarksTagsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'tag_id' => ['type' => 'index', 'columns' => ['tag_id', 'bookmark_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['bookmark_id', 'tag_id'], 'length' => []],
            'bookmarks_tags_ibfk_1' => ['type' => 'foreign', 'columns' => ['tag_id'], 'references' => ['tags', 'id'], 'update' => 'noAction', 'delete' => 'cascade', 'length' => []],
            'bookmarks_tags_ibfk_2' => ['type' => 'foreign', 'columns' => ['bookmark_id'], 'references' => ['bookmarks', 'id'], 'update' => 'noAction', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
