        ...
        <ul>
            ...
            <li>
                <figure id="size-img" >
                    ...
                    <div id="txt_background_color">  <div class="text-center"><div class="head_title"><b> <?= $this->Html->link(__( ($productSubCategorie->title) ), ['action' => 'view', base64_encode($productSubCategorie->id)]) ?></b></div></div>
                       </div> </div>
