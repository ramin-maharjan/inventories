...
<div class="course_contents">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="form-group col-md-9">
                                <?php echo $this->Form->input('title',['label' => false, 'placeholder'=>'Category Title','id'=>'category_title', 'class'=>'form-control','required'=>false,'autocomplete'=>'off' ]);?>
                 ...
                 <tr class='hover_image'><td>
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="form-group col-md-9">
                        <?php echo $this->Form->input('image',['label' => false, 'placeholder'=>'Category Image', 'class'=>'form-control image','type'=>'file','multiple'=>true]);?>                                <div id="description_error"></div>
                            </div>
                        </div>
                    </div>
                 </td></tr>
 ...
 <?php $cancel_url= \Cake\Routing\Router::url(
    ...
    <div id="button_position">
        <?php echo $this->Form->button( 'Cancel' ,['onclick' =>"location.href='$cancel_url'",'class' => 'btn btn-cancel uppercase magnificCancel', 'div' => false,'form'=>'','autocomplete'=>'off']);?>
