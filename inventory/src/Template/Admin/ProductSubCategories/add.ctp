                ...
                <tr><td>
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="form-group col-md-9">
                                <?php echo $this->Form->input('title',['label' => false, 'placeholder'=>' Sub Category Title','id'=>'sub_category_title', 'class'=>'form-control','required'=>false,'autocomplete'=>'off' ]);?>
                  ...
                  <tr class='hover_image'><td>
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="form-group col-md-9">
                        <?php echo $this->Form->input('image',['label' => false, 'placeholder'=>'Sub-Category Image', 'class'=>'form-control image','type'=>'file','multiple'=>true]);?>                                <div id="description_error"></div>
                            </div>
                        </div>
                    </div>
                 </td></tr>
