                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="form-group col-md-9">
                                <?php echo $this->Form->input('product_category_id',['options' => $productCategory,'label' => false, 'placeholder'=>'Choose a category','empty'=>'Select a Category','id'=>'product_category', 'class'=>'form-control','required'=>false,'autocomplete'=>'off' ]);?>
                ...
                <tr><td>
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="form-group col-md-9">
                                <?php echo $this->Form->input('product_sub_category_id',['options' => $productSubCategory,'label' => false, 'placeholder'=>'Choose a Sub category','empty'=>'Select a Category','id'=>'product_sub_category', 'class'=>'form-control','required'=>false,'autocomplete'=>'off' ]);?>
                ...
                <tr><td>
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="form-group col-md-9">
                                <?php echo $this->Form->input('name',['label' => false, 'placeholder'=>'Product Name','id'=>'product_name', 'class'=>'form-control','required'=>false,'autocomplete'=>'off' ]);?>
                ...
                <tr class='hover_image'><td>
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="form-group col-md-9">
                        <?php echo $this->Form->input('image',['label' => false, 'placeholder'=>'Product Image', 'class'=>'form-control image','type'=>'file','multiple'=>true]);?>                                <div id="description_error"></div>
                            </div>
                        </div>
                    </div>
                 </td></tr>
