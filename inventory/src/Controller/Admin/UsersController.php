...
class UsersController extends AppController
{
     ...
     */
     public function initialize() {
        parent::initialize();
        $this->Auth->allow(['add','logout', 'forgotPassword','forgot']);
    }
...
//        die();
   ...
   public function login() {
            ...
            if ($user) {
                if ($user['status'] == 1 ) {
                    ...
                    return $this->redirect($this->Auth->redirectUrl());
                        ...
                        $this->Flash->error('This user is not an admin or a customer.');
                    }
                } else {
    ...
    public function logout()
        {
            $this->Flash->customer('You have been logged out.');
    ...
    public function forgotPassword() {
        ...
        if ($this->request->is('post')) {
            ...
            if (empty($user)) {
                ...
                $reset_link=  Router::url(['controller'=>'Users','action'=>'forgot','prefix'=>'admin',$this->encode($user->id),$user->activation_key],true);
...
//        
//        if ($this->request->is('post')) {
//            $customer = $this->Customers->patchEntity($user, $this->request->data);
//           
